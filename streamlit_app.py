    ...
    if page == "Dashboard Overview":
        ...
        if not df.empty:
            ...
            with col1:
                ...
                fig_rfm_bar = px.bar(segment_counts, x=segment_counts.index, y=segment_counts.values, title="Number of Customers by RFM Segment", labels={'index': 'Segment', 'value': 'Frequency'})
